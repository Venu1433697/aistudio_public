        ...
        {isAuthenticated ? (
          <>
            <Routes>
              ...
              <Route path="/billing" element={<DashboardLayout onLogout={handleLogoutClick} currentPage="billing" />} />
              <Route path="/billing/:userId" element={<DashboardLayout onLogout={handleLogoutClick} currentPage="billing-details" />} />
              <Route path="*" element={<Navigate to="/dashboard" replace />} />
            </Routes>
            <ConfirmDialog
