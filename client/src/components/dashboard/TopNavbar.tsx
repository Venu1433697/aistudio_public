...
export const TopNavbar: React.FC<TopNavbarProps> = ({ onLogout, onNavigate, profileImage }) => {
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div className="flex items-center gap-3 relative group cursor-pointer">
          <div className="w-9 h-9 rounded-full overflow-hidden border border-gray-300 group-hover:border-gray-500 transition-all">
            <img src={profileImage || defaultAvatar} alt="Profile" className="w-full h-full bg-gray-100 object-cover" />
          </div>
