      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-500">
            <li><button onClick={() => handleNavClick('/services/waterproofing')} className="hover:text-black transition-colors text-left">Waterproofing</button></li>
            <li><button onClick={() => handleNavClick('/services/polyurethane')} className="hover:text-black transition-colors text-left">Polyurethane Sealing</button></li>
            <li><button onClick={() => handleNavClick('/services/piping')} className="hover:text-black transition-colors text-left">Industrial Piping</button></li>
            <li><button onClick={() => handleNavClick('/services/construction')} className="hover:text-black transition-colors text-left">Construction</button></li>
            <li><button onClick={() => handleNavClick('/services/instrument-repair')} className="hover:text-black transition-colors text-left">Instrument Repair</button></li>
          </ul>
        </div>
        <div>
